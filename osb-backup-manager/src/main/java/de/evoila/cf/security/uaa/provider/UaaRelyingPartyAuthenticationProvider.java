/** */
package de.evoila.cf.security.uaa.provider;


import de.evoila.cf.security.uaa.ScopeAuthority;
import de.evoila.cf.security.uaa.UaaUserDetails;
...
public class UaaRelyingPartyAuthenticationProvider implements AuthenticationProvider, InitializingBean {
    ...
    public static class Properties {
        ...
        public static final String UAA_URL = "iss";
    ...
    public Authentication authenticate(final Authentication authentication) throws AuthenticationException {
        ...
        userDetails.setToken(auth.getToken());
        userDetails.setUserId(tokenObj.get(Properties.USER_ID).toString());
        userDetails.setUaaUrl(tokenObj.get(Properties.UAA_URL).toString());
