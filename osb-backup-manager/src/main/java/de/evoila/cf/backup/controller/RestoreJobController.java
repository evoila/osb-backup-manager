...
public class RestoreJobController {
    ...
    @Operation(summary = "Gets a job with the given id from the repository.")
    @GetMapping("/restoreJobs/{jobId}")
    ...
    @Operation(summary = "Gets a page of configured jobs for the specified service instance.")
    @GetMapping("/restoreJobs/byInstance/{serviceInstanceId}")
