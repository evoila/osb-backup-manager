...
public class BackupJobController {
    ...
    @RequestMapping(value = "/backupJobs/byInstance/{instanceId}", method = RequestMethod.GET)
    ...
    @RequestMapping(value = "/backupJobs/byInstance/{instanceId}/filtered", method = RequestMethod.GET)
